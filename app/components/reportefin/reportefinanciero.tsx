    ...
    return (
        <div className="p-6 bg-black w-[90%] text-white min-h-screen ">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                ...
                <div className="p-4 bg-red-700 rounded-md shadow-md">
                ...
                <div className={`p-4 ${gananciasNetas >= 0 ? "bg-blue-700" : "bg-red-800"} rounded-md shadow-md`}>
            ...
            <div className="bg-gray-900 p-6 rounded-md shadow-md mb-8">
                ...
                <div className="overflow-x-auto">
                    <table className="table-auto w-full text-left text-sm text-gray-300">
                        ...
                        <tbody>
                            {ventas.map((venta) => (
                                <tr key={venta.id} className="border-b border-gray-700">
                                    ...
                                    <td className="px-4 py-2">{venta.monto.toLocaleString("es-CO")} COP</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            {gastos.map((gasto) => (
                                <tr key={gasto.id} className="border-b border-gray-700">
                                    ...
                                    <td className="px-4 py-2">-{gasto.monto.toLocaleString("es-CO")} COP</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
